...
function Coupon_001({ setIsPossible, navigation }) {
      ...
      <ScrollView bounces={false}>
        <View style={styles.rootContainer}>
          ...
          >
            ...
            <CouponItem
              image={coupons[couponIds[0]].image}
              title={coupons[couponIds[0]].title}
